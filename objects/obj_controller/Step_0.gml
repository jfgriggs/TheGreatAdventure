...
switch (global.game_state) {
	...
	case GAME_STATE.PLAYING:
		...
		if (keyboard_check_pressed(vk_escape)) {
			...
			show_debug_message(
				"global.game_state == GAME_STATE.PAUSED == " + string(global.game_state)
			);
		}
	...
	case GAME_STATE.PAUSED:
		...
		if (keyboard_check_pressed(ord("Y"))) {
			...
			show_debug_message(
				"global.game_state == GAME_STATE.STARTING == " + string(global.game_state)
			);
		}
		...
		if (keyboard_check_pressed(ord("N"))) {
			...
			show_debug_message(
				"global.game_state == GAME_STATE.PLAYING == " + string(global.game_state)
			);
		}
		break;
	...
	case GAME_STATE.GAME_OVER:
		show_debug_message(
			"global.game_state == GAME_STATE.GAME_OVER == " + string(global.game_state)
		);
