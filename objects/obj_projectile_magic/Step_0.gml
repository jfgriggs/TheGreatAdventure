...
/// FORWARD MOVEMENT
/// =========================
var forward_x = lengthdir_x(distance_traveled, travel_dir);

var forward_y = lengthdir_y(distance_traveled, travel_dir);

/// =========================
/// SINE OFFSET
/// =========================
var wave_offset = sin(wave_time) * wave_amplitude;
...
/// SIDEWAYS OFFSET
/// =========================
var side_x = lengthdir_x(wave_offset, side_dir);

var side_y = lengthdir_y(wave_offset, side_dir);
